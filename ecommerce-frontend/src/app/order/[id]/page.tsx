    ...
    <main className="min-h-screen bg-muted/30 pb-20">
      ...
      <div className="bg-background border-b pt-16 pb-12">
        <div className="container mx-auto px-4 max-w-4xl flex flex-col items-center text-center">
          ...
          <Button
            variant="outline"
            className="rounded-full shadow-sm color-primary hover:border-primary transition-colors"
          >
      ...
      <div className="container mx-auto px-4 py-10 max-w-5xl">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          `}
                          >
                            <Icon
                              className={`w-5 h-5 transition-transform duration-500 ${isCurrent ? "animate-[spin_3s_linear_infinite]" : ""} ${step.status.toUpperCase() === "PROCESSING" && isCurrent ? "animate-[spin_3s_linear_infinite]" : ""}`}
                            />
                          </div>
