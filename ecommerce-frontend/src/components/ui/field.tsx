...
function FieldLabel({
  ...
  return (
    <Label
      ...
      className={cn(
        "tw-:group/field-label tw-:peer/field-label tw-:flex tw-:w-fit tw-:gap-2 tw-:leading-snug tw-:group-data-[disabled=true]/field:opacity-50 tw-:has-data-checked:bg-input/30 tw-:has-[>[data-slot=field]]:rounded-2xl tw-:has-[>[data-slot=field]]:border tw-:has-[>[data-slot=field]]:not-has-[:disabled,[data-disabled]]:hover:bg-input/40 tw-:has-[>[data-slot=field]]:has-[:focus-visible]:border-ring tw-:has-[>[data-slot=field]]:has-[:focus-visible]:ring-3 tw-:has-[>[data-slot=field]]:has-[:focus-visible]:ring-ring/50 tw-:*:data-[slot=field]:p-4",
